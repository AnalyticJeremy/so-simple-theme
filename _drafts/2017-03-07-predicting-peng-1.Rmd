...
Data science hero [Roger Peng](http://www.biostat.jhsph.edu/~rpeng/) is the co-host of two different podcasts. &nbsp;First,
he joined [Hilary Parker](https://hilaryparker.com/about-hilary-parker/) on a data science podcast called
"[`r name`](https://soundcloud.com/nssd-podcast)". &nbsp;Their first episode was released on
...
"`r efrp.name`" has been releasing episodes at a much faster rate. &nbsp;Therefore, we can expect that the number of episodes
